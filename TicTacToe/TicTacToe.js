...
function boxClick(box) {
    if (box.value === '') {
        ...
        document.getElementById('invalidMove').innerText = '';
        //document.getElementById('winMessage').innerText = '';
    } else {
        document.getElementById('invalidMove').innerText = 'Invalid move. The space is already taken.';
    }
}
...
function checkWinner() {
    ...
    if (checkLine(0, 1, 2) || checkLine(3, 4, 5) || checkLine(6, 7, 8) ||
        ...
        document.getElementById('winMessage').innerText = currentPlayer + ' wins!';
        resetBoard();
